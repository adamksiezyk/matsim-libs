 ...
 * @author dgrether
 */
public final class PsoSignalPlan implements SignalPlan {

	private DatabasedSignalPlan delegate;
	private List<PsoExtensionPoint> extensionPoints = new ArrayList<PsoExtensionPoint>();
	private int maxExtensionTime = 0;
	private int fixedTimeCycle = 0;


	public PsoSignalPlan(DatabasedSignalPlan delegate) {
	...
	public void addExtensionPoint(PsoExtensionPoint extensionPoint) {
		this.extensionPoints.add(extensionPoint);
	}

	public List<PsoExtensionPoint> getExtensionPoints() {
